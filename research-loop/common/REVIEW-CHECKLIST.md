...
- B3. Does every failed attempt have an issue with its stage, and is the run row cited as evidence the latest attempt with exit status ok? (principle-10.) PENDING(part 09 L23)
...
- D3. Was every issue that a fix answered replied to and closed? (rule-09.) PENDING(part 09 L23)
