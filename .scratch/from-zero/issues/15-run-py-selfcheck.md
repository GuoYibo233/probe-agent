...
- 2026-09-20, wave 6 post-merge review (fork5): five opus finders, every finding checked by a second opus agent; 30 verified (3 critical, 13 important, 14 minor), 6 refuted. Area selfcheck fixed on fix/2026-09-20-wave6-selfcheck (two re-review rounds) and fix/2026-09-20-wave6-r3 (one re-review), merged as b53726b / 81df864 / 2ffbbaa; records post-merge-review.json, post-merge-fix.json and post-merge-fix-selfcheck.md under .scratch/from-zero/sdd/2026-09-19-wave6/. Items left open for the owner are in the errata's last entries.
