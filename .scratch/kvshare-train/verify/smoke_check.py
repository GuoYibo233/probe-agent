...
默认块(16,384 个 token、1,984 个损失位)代进去就是 plan-8-28 来信里的四个数:b17 不开检查点 94.8、
l17 不开 74.5、l4 开 38.1、b06 开 17.9(来信写 94.9 是四舍五入的差)。偏差 = (实测 − 预期) / 预期,
...
MB_PER_TOKEN = {  # (不开检查点, 开检查点)
    "b06": (2.44, 0.21), "b17": (3.68, 0.38), "l17": (3.68, 0.38), "l4": (7.32, 0.60)}
MB_PER_LOSS_POS = 1.8
