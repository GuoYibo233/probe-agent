...
- **方向**：kvshare-train ｜ **状态**：ok ｜ **起止**：2026-08-28 23:15 → 2026-08-28 23:40
- **代码**：`35fd401` (分支 main)
- **机器**：tokyo108 GPU 2
- **数字**：align_max_abs_diff=5.48e-06 worst_gb_loop=15.219 best_val_ce=1.2917 val_exact_call=0.1728 gen_s=68.4 wall_s=168.8
- **日志**：`/home/y-guo/reproduce/new1/logs/new1_ks828b06_gptoss_cgen_smoke3_t108g2.log`
...
- **结论**：b06 cgen smoke2(H100, 探针 cost 三块): 对齐 PASS, cost worst 15.35 GB(max_tokens_block, scope=run 40 事件), 生成评估 81 行 70.6 s
- **方向**：kvshare-train ｜ **状态**：ok ｜ **起止**：2026-08-28 23:14 → 2026-08-28 23:40
- **代码**：`35fd401` (分支 main)
- **机器**：tokyo108 GPU 1
- **数字**：align_max_abs_diff=5.48e-06 worst_gb_cost=15.345 best_val_ce=1.2917 val_exact_call=0.1728 gen_s=70.6 wall_s=158.8
- **日志**：`/home/y-guo/reproduce/new1/logs/new1_ks828b06_gptoss_cgen_smoke2_t108g1.log`
...
- **日志**：`/home/y-guo/reproduce/new1/logs/new1_ks828l4_gptoss_cgen_smoke_t108g0.log`
...
- **结论**：l17 cgen smoke(H200, LoRA 不开检查点, 探针 tokens): 对齐 PASS, 探针最满块 77.62 GB(预期 74.5, +4.2%), ×1.1=85.4; 生成评估 81 行 90.5 s
- **方向**：kvshare-train ｜ **状态**：ok ｜ **起止**：2026-08-28 23:13 → 2026-08-28 23:40
- **代码**：`35fd401` (分支 main)
- **机器**：tokyo108 GPU 4
- **数字**：align_max_abs_diff=9.06e-06 worst_gb_tokens=77.618 step_peak_gb=49.92 best_val_ce=1.3977 val_exact_call=0.1852 gen_s=90.5 wall_s=877.7
- **日志**：`/home/y-guo/reproduce/new1/logs/new1_ks828l17_gptoss_cgen_smoke_t108g4.log`
...
- **结论**：b17 cgen smoke(H200, 不开检查点, 探针 tokens): 对齐 PASS, 探针最满块 98.25 GB(预期 94.8, +3.6%), ×1.1=108.1 在 H200 143 GB 内; 生成评估 81 行 86.4 s
- **方向**：kvshare-train ｜ **状态**：ok ｜ **起止**：2026-08-28 23:12 → 2026-08-28 23:40
- **代码**：`b7ff390` (分支 main)
- **机器**：tokyo108 GPU 3
- **数字**：align_max_abs_diff=9.06e-06 worst_gb_tokens=98.245 step_peak_gb=70.42 best_val_ce=1.59 val_exact_call=0.1852 gen_s=86.4 wall_s=818.8
- **日志**：`/home/y-guo/reproduce/new1/logs/new1_ks828b17_gptoss_cgen_smoke_t108g3.log`
...
- **结论**：ctool smoke 在 H100 gpu0 上 max_len 8192 bs 2 accum 4(仍 8 事件一次更新)跑通: nvidia-smi 2 秒采样 165 个样本最大 56,859 MiB(p90 56,855), 25 次更新, 对齐 PASS(3e-4), dropped_events 1/3 与 plan 第四节 8192 行相符; bs 4 在同卡 OOM, 决定 15 退路生效
- **方向**：kvshare-train ｜ **状态**：ok ｜ **起止**：2026-08-28 13:33 → 2026-08-28 13:39
- **代码**：`7008dff` (分支 main)
- **机器**：tokyo108 GPU 0
- **数字**：peak_mem_used_mib=56859 steps=25 calA_weighted_acc=0.394 dropped_events_train=1 dropped_events_val=3
- **日志**：`/home/y-guo/reproduce/new1/logs/new1_ks828b06_gptoss_ctool_h100mem_bs2_t108g0.log`
- **命令**：`bash /net/tokyo100-10g/data/str01_01/y-guo/reproduce/new1/pipeline/runs/smoke/ks828b06_gptoss_ctool_h100mem_bs2/memwrap.sh /net/tokyo100-10g/data/str01_01/y-guo/reproduce/new1/pipeline/runs/smoke/ks828b06_gptoss_ctool_h100mem_bs2 /home/y-guo/reproduce/new1/cprobe-env/bin/python /home/y-guo/reproduce/new1/pipeline/train/train_causal_tool.py --base qwen --env appworld --data /home/y-guo/reproduce/new1/pipeline/data/nyapass_aw_v1/gptoss --out /net/tokyo100-10g/data/str01_01/y-guo/reproduce/new1/pipeline/runs/smoke/ks828b06_gptoss_ctool_h100mem_bs2 --smoke --force --bs 2 --accum 4`
...
- **结论**：np821l4 cparam 评测(risk 0.05, θ 0.975): 2192 触发事件, parse_fail 0, pred_tool full_call_ok 0.8654/params_all_ok 0.8828, gt_tool params_all_ok 0.8969, H200 约 24 分钟
- **方向**：eval_np821l4 ｜ **状态**：ok ｜ **起止**：2026-08-26 04:47 → 2026-08-26 05:15
- **代码**：`15c90e8` (分支 main)
- **机器**：tokyo108 GPU 3
- **数字**：risk=0.05 theta=0.975 n_scored=2192 parse_fail=0 pred_tool_ok=0.9599 pred_params_all_ok=0.8828 pred_full_call_ok=0.8654 pred_exact_call_ok=0.8645 pred_param_acc=0.8251 gt_params_all_ok=0.8969 gt_param_acc=0.8794 noparam_rate=0.3828
- **原始数据**：`/home/y-guo/reproduce/new1/pipeline/runs/np821l4_gptoss_cparam`（不在 git 里）
- **日志**：`/home/y-guo/reproduce/new1/logs/eval_np821l4_gptoss_cparam.log`
...
- **结论**：np821l4 cgen 评测(risk 0.05, θ 0.975): 2192 触发事件, parse_fail 0, tool_ok 0.9056, params_all_ok 0.8472, full_call_ok 0.8294, H100 约 23 分钟
- **方向**：eval_np821l4 ｜ **状态**：ok ｜ **起止**：2026-08-26 04:46 → 2026-08-26 05:14
- **代码**：`15c90e8` (分支 main)
- **机器**：tokyo108 GPU 2
- **数字**：risk=0.05 theta=0.975 n_scored=2192 parse_fail=0 tool_ok=0.9056 params_all_ok=0.8472 full_call_ok=0.8294 exact_call_ok=0.8271 param_acc=0.7291 noparam_rate=0.3828
- **原始数据**：`/home/y-guo/reproduce/new1/pipeline/runs/np821l4_gptoss_cgen`（不在 git 里）
- **日志**：`/home/y-guo/reproduce/new1/logs/eval_np821l4_gptoss_cgen.log`
...
- **结论**：np821b06 cparam 评测(risk 0.05, θ 0.975): 2227 触发事件, parse_fail 0, pred_tool full_call_ok 0.8752/params_all_ok 0.9026, gt_tool params_all_ok 0.9106, H200 约 22 分钟
- **方向**：eval_np821b06 ｜ **状态**：ok ｜ **起止**：2026-08-26 04:38 → 2026-08-26 05:01
- **代码**：`d4ff119` (分支 main)
- **机器**：tokyo108 GPU 5
- **数字**：risk=0.05 theta=0.975 n_scored=2227 parse_fail=0 pred_tool_ok=0.9529 pred_params_all_ok=0.9026 pred_full_call_ok=0.8752 pred_exact_call_ok=0.8765 pred_param_acc=0.8182 gt_params_all_ok=0.9106 gt_param_acc=0.8693 noparam_rate=0.467
...
- **结论**：np821b06 cgen 评测(risk 0.05, θ 0.975): 2227 触发事件, parse_fail 0, tool_ok 0.9057, params_all_ok 0.8702, full_call_ok 0.8276, H200 约 23 分钟
- **方向**：eval_np821b06 ｜ **状态**：ok ｜ **起止**：2026-08-26 04:38 → 2026-08-26 05:02
- **代码**：`d4ff119` (分支 main)
- **机器**：tokyo108 GPU 4
- **数字**：risk=0.05 theta=0.975 n_scored=2227 parse_fail=0 tool_ok=0.9057 params_all_ok=0.8702 full_call_ok=0.8276 exact_call_ok=0.8289 param_acc=0.7406 noparam_rate=0.467
...
- **结论**：np821l4 ctool 评测出报告, 0.05 档 θ=0.975(0.1 档 0.875), test 冻结 0.05 档 coverage 0.2569 trig_acc 0.9599 earliness 0.3886 wrong_spec 0.0103, H200 约 48 分钟
- **方向**：eval_np821l4 ｜ **状态**：ok ｜ **起止**：2026-08-26 03:58 → 2026-08-26 04:46
- **代码**：`1edd5ae` (分支 main)
- **机器**：tokyo108 GPU 3
- **数字**：theta_005=0.975 theta_01=0.875 coverage=0.2569 trig_acc=0.9599 earliness=0.3886 wrong_spec=0.0103 temperature=1.2704 prior_acc=0.3867 n_events_test=8533
...
- **结论**：np821 l17 cparam(Qwen3-1.7B LoRA+gc, Ada) 3ep 完成, best_val_ce 0.3146, 墙钟约 98.3h
- **方向**：probe_np821l17 ｜ **状态**：ok ｜ **起止**：2026-08-22 12:04 → 2026-08-26 14:36
- **代码**：`1b9334f` (分支 main)
- **机器**：tokyo107 GPU 2
- **数字**：best_val_ce=0.3146 gsteps=17484
- **原始数据**：`/home/y-guo/reproduce/new1/pipeline/runs/np821l17_gptoss_cparam`（不在 git 里）
