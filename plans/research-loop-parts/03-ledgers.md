...
- 2026-08-17 晨问题 6–30 落进本份之后，本份牵出去、还等统筹落的（`04`、`05` 已各自改完；落点全在 HANDOFF 第八节的表里，这里只列本份定义处变了、引用处要跟的）：——已同步 2026-08-17 夜，rl-hub-v3 `70c766b`（下面各条含 `04:133`「裸终端」措辞题：04 已冻结，那三个字不动，`04:158`/`05:40`/`03` 三处已是同一个意思）。
