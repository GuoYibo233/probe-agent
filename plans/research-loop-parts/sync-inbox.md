...
- 问题 2：推送表（哪些事件推桌面通知）和 `rl notify` 是一件事还是两件事？原表把推送表归 `01`、notify 归 `05`；`07`、`10`、`11`、`20`、`25` 指 `01`，`09`、`22`、`23`、`24` 指 `05`。——已裁 2026-08-17：一件事，归 `01`，原话「算一件事」「给rl notify指到01吧」。已处理：`01` 第五节补一句并记裁决；`09`/`22`/`23`/`24` 指向改 `01`；HANDOFF 四点五节改；`05`「rl notify」一节缩成一句指 `01`、命令表只留签名行，交 rl-part-05（`05` 那节里 `01` 没有的句子由 rl-part-05 定稿时报上来再搬进 `01`）。
