...
- 来源 envs/bert_data/v3_1 -> envs/bert_data/v3_1_xmodel;侧=样本 model 字段前缀(qwen*/gpt-oss*)
...
| split | qwen 事件·样本 | gptoss 事件·样本 |
|---|---|---|
| train | 1605·25061 | 748·22738 |
| calA | 220·4120 | 100·3159 |
| calB | 214·3675 | 103·3176 |
| test | 226·3487 | 109·3090 |

- train 分模型事件计数: gpt-oss-120b 748 / qwen3.5-27b 855 / qwen3.6-27b 750

## 用法(A 线发射用)

训练(每侧一模型,--out 必须显式):
```
train_probe.py --env <env> --data envs/bert_data/v3_1_xmodel/train-<侧> --out envs/bert_runs/<env>_v3_x<侧>
```
...
eval_replay.py --env <env> --run envs/bert_runs/<env>_x/<...> --data envs/bert_data/v3_1_xmodel/eval-<考侧>_cal-<校准侧>
```
